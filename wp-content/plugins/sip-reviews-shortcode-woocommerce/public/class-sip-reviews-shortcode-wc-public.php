...
class SIP_Reviews_Shortcode_Public {
			...
			<div class="wrap">
				<div>
					...
					<div class="shortcode_add">
						<table>
							<tr>
								<th><label for="woocommerce_review_id">Product :</label></th>
								<td>
								<?php
									$args = array(
										'post_type' => 'product',
							...
							<tr>
								<th><label for="woocommerce_review_title">Custom Product Title :</label></th>
	...
	public function sip_rswc_add_styles_scripts(){
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/settings.js', array( 'jquery' ), $this->version, true );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name . "-barrating", plugin_dir_url( __FILE__ ) . 'js/jquery.barrating.js', array( 'jquery' ), $this->version, true );
		wp_enqueue_script( $this->plugin_name . "-plugin", plugin_dir_url( __FILE__ ) . 'js/plugins.js', array( 'jquery' ), $this->version, true );
