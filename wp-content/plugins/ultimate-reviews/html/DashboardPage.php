...
?>
	...
	<div id="ewd-dashboard-box-links" class="ewd-urp-dashboard-box" >
		...
		<div class="ewd-dashboard-box-value-and-field-container">
		  <div class="ewd-dashboard-box-value ewd-font-22"><?php echo $wpdb->get_var("SELECT post_date FROM $wpdb->posts WHERE post_type='urp_review' ORDER BY post_date DESC"); ?>
		  </div>
