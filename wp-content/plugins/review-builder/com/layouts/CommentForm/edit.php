				...
				<div class="sg-col-12">
					<div class="sg-box sgrb-form-general-box">
						<div class="sg-box-title">
							<?php echo _e('Comment box settings', 'sgrb');?>
						</div>
						<div class="sg-box-content">
							<div class="sg-row" style="margin-bottom: 20px;">
								<div class="sg-col-1">
									<div style="margin:10px auto;">
										<label for="sgrb-comment-box-theme-1" style="font-size: 22px;">Default:</label>
									</div>
								</div>
								<div class="sg-col-1">
									<div style="margin:10px auto;">
								...
								<div class="sg-col-10 sgrb-form-textareas-wrapper">
									<div class="sgrb-comment-box-main-wrapper">
										...
										<div class="sgrb-rate-setting" style="height: 22px;padding: 5px 0;">
											<div class="sg-col-5">
												...
												<label for="sgrb-comment-box-rate-show"> - show rate</label>
											</div>
											<div class="sgrb-rate-box-disable-js<?php echo (!@$options['comment-box-rate-show']) ? ' sgrb-disabled': '' ;?>">
												<div class="sg-col-3">
													...
													<label for="sgrb-comment-box-rate-alignment-left"> - left</label>
												</div>
												<div class="sg-col-2">
													<div class="sgrb-radio-wrapper">
													...
													<label for="sgrb-comment-box-rate-alignment-center"> - center</label>
												</div>
												<div class="sg-col-2">
													<div class="sgrb-radio-wrapper">
													...
													<label for="sgrb-comment-box-rate-alignment-right"> - right</label>
												</div>
											</div>
										</div>

										<div class="sgrb-each-rate-box sgrb-comment-box-stars-hide-show-js" style="width: 100%;height: 40px;background-color: #f1f1f1;">
										...
										<div class="sgrb-rate-setting" style="height: 22px;padding: 5px 0;">
											<div class="sg-col-5">
												...
												<label for="sgrb-comment-box-title-show"> - show title</label>
											</div>
											<div class="sgrb-title-box-disable-js<?php echo (!@$options['comment-box-title-show']) ? ' sgrb-disabled': '' ;?>">
												<div class="sg-col-3">
													...
													<label for="sgrb-comment-box-title-alignment-left"> - left</label>
												</div>
												<div class="sg-col-2">
													<div class="sgrb-radio-wrapper">
													...
													<label for="sgrb-comment-box-title-alignment-center"> - center</label>
												</div>
												<div class="sg-col-2">
													<div class="sgrb-radio-wrapper">
													...
													<label for="sgrb-comment-box-title-alignment-right"> - right</label>
												</div>
											</div>
										</div>
										...
										<div class="sgrb-comment-avatar-box">
											<div class="sgrb-rate-setting" style="height: 22px;padding: 5px 0;">
												<div class="sg-col-5">
													...
													<label for="sgrb-comment-box-avatar-show"> - show image</label>
													<div class="sgrb-checkbox-wrapper">
													...
													<label for="sgrb-comment-box-text-show"> - show text</label>
												</div>
												<div class="sgrb-avatar-text-disable-js<?php echo (!@$options['comment-box-avatar'] || !@$options['comment-box-text']) ? ' sgrb-disabled' : '';?>">
													<div class="sg-col-3">
														...
														<label for="sgrb-comment-box-avatar-and-text-alignment-default"> - default</label>
													</div>
													<div class="sg-col-2">
														<div class="sgrb-radio-wrapper">
														...
														<label for="sgrb-comment-box-avatar-and-text-alignment-reverse"> - reverse</label>
													</div>
												</div>
											</div>
											<div class="sgrb-user-avatar-wrapper sgrb-avatar-disable-js<?php echo (!@$options['comment-box-avatar']) ? ' sgrb-disabled' : '';?>" style="<?php echo (!SGRB_PRO_VERSION) ? 'opacity: 0.6;': '';?><?php echo (@$options['comment-box-avatar-and-text-alignment'] == 1) ? 'float: left;' : 'float: right;';?>">
												<img style="float: left;padding: 0 30%;" src="<?php echo $sgrb->app_url.'assets/page/img/avatar.png' ;?>" width="100px" height="100px">
											</div>
										...
										<div class="sgrb-rate-setting" style="height: 22px;padding: 5px 0;">
											<div class="sg-col-5">
												...
												<label for="sgrb-comment-box-date-show"> - show date</label>
												<div class="sgrb-checkbox-wrapper">
												...
												<label for="sgrb-comment-box-comment-by-show"> - show comment by</label>
											</div>
											<div class="sgrb-date-comment-by-disable-js<?php echo (!@$options['comment-box-comment-by-show'] && !@$options['comment-box-date-show']) ? ' sgrb-disabled' : '';?>">
												<div class="sg-col-3">
													...
													<label for="sgrb-comment-box-date-left"> - left</label>
												</div>
												<div class="sg-col-2">
													<div class="sgrb-radio-wrapper">
													...
													<label for="sgrb-comment-box-date-center"> - center</label>
												</div>
												<div class="sg-col-2">
													<div class="sgrb-radio-wrapper">
													...
													<label for="sgrb-comment-box-date-right"> - right</label>
												</div>
											</div>
										</div>
										...
										<div class="sgrb-comment-title-box"<?php echo (!SGRB_PRO_VERSION) ? ' style="opacity: 0.6;"': '';?>>
											<div class="sgrb-col-3">
												<div class="sgrb-comment-box-title" style="text-align:<?php echo (@$options['comment-box-date-alignment']) ? @$options['comment-box-date-alignment'] : 'right';?>">
													...
													<span class="sgrb-comment-by-hide-show-js<?php echo (!@$options['comment-box-comment-by-show']) ? ' sgrb-disabled' : '';?>">comment by ...</span>
												</div>
											</div>
										</div>
