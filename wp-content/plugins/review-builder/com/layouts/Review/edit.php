						...
						<div class="container-fluida">
							...
							<div class="navbar-header">
								<div style="width:366px;overflow:hidden">
									<input class="sgrb-text-input sgrb-title-input sgrb-reviewupdate-js" value="<?php echo esc_attr(@$sgrbDataArray['title']); ?>" autofocus="" name="sgrb-title" placeholder="Enter title here" style="margin-top: 14px;height:100%;width: 190px !important;" autocomplete="off" type="text">
									<?php if (!@$sgrbRev->getId()) :?>
										<div class="tooltip fade right in">
											<div class="tooltip-arrow"></div>
											<div class="tooltip-inner"> type review title </div>
										</div>
									<?php endif;?>
								</div>
							</div>
							<div class="collapse navbar-collapse navbar-right navbar-ex1-collapse">
								<ul class="nav navbar-nav list-inline" style="margin-bottom: 10px;">
									<li class="menuItem" style="margin: 0;"><button type="button" class="btn btn-default prev-step sgrb-previous-step disabled" style="margin-top: 15px;">Previous</button></li>
									<li class="menuItem" style="margin: 0;"><button type="button" class="btn btn-default next-step sgrb-skip-step next-skip disabled" style="margin-top: 15px;">Skip</button></li>
									<li class="menuItem" style="margin: 0;">
										<?php if ($sgrbRev->getId()) :?>
											<button onclick="SGReview.prototype.save();" type="button" class="sgrb-review-save-button btn btn-primary btn-info-full" style="margin-top: 15px;">Save</button>
										<?php else :?>
											<button type="button" class="sgrb-review-save-button btn btn-primary btn-info-full next-step sgrb-next-step disabled" style="margin-top: 15px;">Continue</button>
										<?php endif ;?>
									</li>
								</ul>
							</div>
						...
						<div class="wizard-inner">
							...
							<ul class="nav nav-tabs" role="tablist">
								...
								<li id="sgrb-wizard-step-1" role="presentation" class="active">
									<a href="#step1" data-toggle="tab" aria-controls="step1" role="tab" title="Select Review Type">
								...
								<li id="sgrb-wizard-step-2" role="presentation" class="disabled">
									<a href="#step2" data-toggle="tab" aria-controls="step2" role="tab" title="Select Template">
								...
								<li id="sgrb-wizard-step-3" role="presentation" class="disabled">
									<a href="#step3" data-toggle="tab" aria-controls="step3" role="tab" title="Options">
										<span class="round-tab">
								...
								<li id="sgrb-wizard-step-4" role="presentation" class="disabled">
									<a href="#step4" data-toggle="tab" aria-controls="step4" role="tab" title="Rate options">
										<span class="round-tab">
								...
								<li id="sgrb-wizard-step-5" role="presentation" class="disabled">
									<a href="#step5" data-toggle="tab" aria-controls="step5" role="tab" title="Localization">
										<span class="round-tab">
											...
											<div class="col-sm-4 block wow bounceIn animated animated" style="visibility: visible;margin:50px 0">
												<div class="row">
													...
													<div class="col-md-6 box-ct">
														<h3> Simple review </h3>
														<p> Single feature to rate, text/image as a template. </p>
													</div>
												</div>
											</div>
											<div class="col-sm-4 block wow bounceIn animated animated" style="visibility: visible;margin:50px 0">
												<div class="row">
													...
													<div class="col-md-6 box-ct">
														...
														<p> Unlimited features to rate with a lot of templates. </p>
													</div>
												</div>
											</div>
											<div class="col-sm-4 block wow bounceIn animated animated" style="visibility: visible;margin:50px 0;">
												<div style="position:relative;">
													<div class="sgrb-coming-soon">
														<img src="<?php echo $sgrb->app_url.'assets/page/img/soon-ribbon.png'; ?>" width="100px">
													</div>
													<div class="row">
														<div class="col-md-4 box-icon<?php echo (@$sgrbDataArray['review-type'] == SGRB_REVIEW_TYPE_SOCIAL) ? ' sgrb-selected-review-type' : '';?>" data-review-type="social_review">
															<span class="dashicons dashicons-share fa-4x" style="display: inline"></span>
														</div>
														<div class="col-md-6 box-ct">
															<h3> Social review </h3>
															<p> Social review lets You get rates and share it in the famous social networks. </p>
														</div>
													</div>
												</div>
											</div>
												...
												<?php endif;?>
													<div class="row">
														...
														<div class="col-md-7 box-ct">
															<h3> Post review </h3>
															<p> Unlimited features to rate Your post. </p>
														</div>
													</div>
											...
											<div class="col-sm-5  block wow bounceIn animated animated" style="visibility: visible;margin:20px 0">
												...
												<?php endif;?>
													<div class="row">
														...
														<div class="col-md-7 box-ct">
															<h3> WooCommerce review </h3>
															<p> WooCommerce review lets You get reviews with our plugin. </p>
														</div>
													</div>
												<?php echo (!SGRB_PRO_VERSION) ? '</div>' : ''?>
											</div>
