...
<div class="sgrb-simple-template-wrapper"<?php echo (@$sgrbDataArray['review-type'] != SGRB_REVIEW_TYPE_SIMPLE || (!@$sgrbDataArray['review-type'] && @$sgrbRev->getId())) ? ' style="display: none;"' : '';?>>
		<div class="row">
		...
		<div class="row" style="margin-bottom: 10px;">
			...
			<div class="col-md-4">
				<div class="sg-tempo-image" style="border: 2px dashed #ccc;border-radius: 10px;height: 250px;margin-top:10px;background-image: url(<?php echo (@$sgrbDataArray['simple-review-template-type'] == 'image') ? @$sgrbDataArray['simple-review-template'] : '';?>);background-repeat: no-repeat;background-position: center;">
...
<div class="sgrb-social-template-wrapper"<?php echo (@$sgrbDataArray['review-type'] != SGRB_REVIEW_TYPE_SOCIAL || (!@$sgrbDataArray['review-type'] && @$sgrbRev->getId())) ? ' style="display: none;"' : '';?>>
	<!-- <div class="row">
		<div class="col-md-12 text-center">
			<h2 class="section-heading"><?php _e('Select the rate skin theme', 'sgrb');?></h2>
		</div>
	</div>
	<div class="row" style="margin-bottom: 10px;">
		...
		<div class="col-md-1">
			<div class="sgrb-radio-wrapper">
				<input type="checkbox" id="sgrb-sample-template-type-empty" name="sgrb-sample-template-type" class="form-control sgrb-sample-template-type" value="empty"<?php echo (@$sgrbDataArray['sgrb-sample-template-type'] == 'empty' || @$sgrbRevId == 0) ? ' checked' : '';?> autocomplete="off">
				<label for="sgrb-sample-template-type-empty"></label>
			</div>
		</div>
		<div class="col-md-4">
			<div id="sgrbRateYoTheme1"></div>
		</div>
	</div> -->
</div>
...
<?php if (SGRB_PRO_VERSION) :?>
	<div class="sgrb-post-template-wrapper"<?php echo (@$sgrbDataArray['template'] == 'post_review') ? '' : ' style="display:none;"';?>>
		<div class="container-fluida">
			...
			<div class="row">
				<div class="col-md-6 text-right">
					<label for="sgrb-disable-wp-comments"><?php echo _e('Disable Wordpress default comments', 'sgrb');?>:</label>
				</div>
				<div class="col-md-1">
	...
	<div class="sgrb-woo-template-wrapper"<?php echo (@$sgrbDataArray['template'] == 'woo_review') ? '' : ' style="display:none;"';?>>
		<div class="container-fluida">
			<div class="row sgrb-disable-woo-comments-wrapper">
				...
				<div class="col-md-5">
					<label for="sgrb-disable-woo-comments">
						 <?php echo _e('Disable WooCommerce products default reviews and comments', 'sgrb');?>
					</label>
				</div>
			</div>
			<div class="row">
			...
			<div class="row" style="margin: 10px 0;">
				<div class="col-md-5 text-right">
					<label for="sgrbWooReviewShowTypeProduct"><?php echo _e('Show review on selected products', 'sgrb');?></label>
				</div>
				<div class="col-md-1">
					<div class="sgrb-radio-wrapper">
							...
							<div class="col-md-8">
								<div class="row" style="padding-top:7px">
									<div class="col-md-9 text-right">
										<?php echo _e('Products to load:', 'sgrb');?>
									</div>
									<div class="col-md-3">
