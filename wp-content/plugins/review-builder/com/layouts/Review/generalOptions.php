<div class="container-fluid">
	<div style="position:relative;background-color:rgba(204, 204, 204, 0.27);">
		...
		<div class="sgrb-require-options-fields" style="opacity:0.7">
			<div class="row">
			...
			<div class="row">
				<div class="col-md-4 text-right">
					<label for="sgrb-email-checkbox">
						<?php echo _e('Notify for new comments to this email', 'sgrb');?>:
				...
				<div class="col-md-6">
					<input class="sgrb-email-notification" type="email" value="<?php echo get_option('admin_email');?>" style="padding:0 5px">
				</div>
			</div>
			<div class="row">
				<div class="col-md-4 text-right">
					<label for="sgrb-required-login-checkbox">
						<?php echo _e('Require login for new comments', 'sgrb');?>:
					</label>
				</div>
				<div class="col-md-7">
					<div class="sgrb-checkbox-wrapper">
			...
			<div class="row">
				<div class="col-md-4 text-right">
					<label for="sgrb-hide-comment-form">
						<?php echo _e('Hide comment form for all users', 'sgrb');?>:
					</label>
				</div>
				<div class="col-md-7">
					<div class="sgrb-checkbox-wrapper">
	...
	<div class="sgrb-require-options-fields">
		<div class="row">
			<div class="col-md-4 text-right">
				<label for="sgrb-auto-approve-checkbox"><?php echo _e('Auto approve comments', 'sgrb');?>:</label>
			</div>
			<div class="col-md-7">
				<div class="sgrb-checkbox-wrapper">
	...
	<div class="sgrb-require-options-fields">
		<div class="row">
			<div class="col-md-4 text-right">
				<span style="vertical-align:sub;"><?php echo _e('Detect user by PC or IP', 'sgrb');?>:</span>
			</div>
			<div class="col-md-7">
	...
	<div class="sgrb-simple-review-categories-wrapper">
		<div class="row">
			<div class="col-md-4 text-right">
				<?php echo _e('Feature to rate', 'sgrb');?>:
			</div>
			<div class="col-md-7">
				<?php if (@$fields == '') :?>
                    <?php if ($simpleField == '') :?>
					<div class="sgrb-one-field">
						...
						<input name="simple-field-name" type="text" value="" placeholder="<?php echo _e('e.g. quality/speed/price of review item', 'sgrb');?>" class="sgrb-field-name" style="width: 100%;padding:0 5px;" autocomplete="off">
				...
				<?php else :?>
					<div class="sgrb-one-field">
						<?php foreach (@$simpleField as $field) : ?>
							...
							<input name="simple-field-name" readonly type="text" value="<?php echo esc_attr(@$field->getName());?>" placeholder="<?php echo _e('e.g. quality/speed/price of review item', 'sgrb');?>" class="sgrb-field-name" style="width: 100%;padding:0 5px;" autocomplete="off">
							<input type="hidden" class="fake-sgrb-id" name="simple-fake-id[]" value="66">
						<?php break;?>
						<?php endforeach;?>
					</div>
	...
	<div class="sgrb-main-review-categories-wrapper">
		<div class="row sgrb-categories-title">
			<div class="col-md-4 text-right">
				<b><?php echo _e('Features to rate', 'sgrb');?> </b>:
			</div>
			<?php if (@$simpleField == '') :?>
				<?php if (empty($fields)) :?>
				<div class="col-md-7">
							...
							<div class="row" style="margin-bottom:5px;">
								<div class="col-md-12">
									<div class="sgrb-one-field" id="clone_1">
										<input<?php echo (@$sgrbRevId != 0) ? ' readonly' : '';?> name="field-name[]" type="text" value="<?php echo esc_attr(@$field->getName());?>"placeholder="<?php echo _e('e.g. quality/speed/price of review item', 'sgrb');?>" class="sgrb-border sgrb-field-name" autocomplete="off">
