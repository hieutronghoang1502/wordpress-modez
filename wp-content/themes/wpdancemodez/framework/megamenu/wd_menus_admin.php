...
function start_el(&$output, $item, $depth = 0, $args = array(), $current_object_id = 0) {
    ...
    if ( ! empty( $item->_invalid ) ) {
        ...
        $title = sprintf( __( '%s (Invalid)','wpdancelaparis' ), $item->title );
    } elseif ( isset( $item->post_status ) && 'draft' == $item->post_status ) {
        $classes[] = 'pending';
        /* translators: %s: title of menu item in draft status */
        $title = sprintf( __('%s (Pending)','wpdancelaparis'), $item->title );
    }
            ...
            <dt class="menu-item-handle">
                ...
                <span class="item-controls">
                    ...
                    <span class="item-order hide-if-js">
                        ...
                        ?>" class="item-move-up"><abbr title="<?php esc_attr_e('Move up','wpdancelaparis'); ?>">&#8593;</abbr></a>
                        |
                        <a href="<?php
                            echo wp_nonce_url(
                                add_query_arg(
                        ...
                        ?>" class="item-move-down"><abbr title="<?php esc_attr_e('Move down','wpdancelaparis'); ?>">&#8595;</abbr></a>
                    </span>
                    <a class="item-edit" id="edit-<?php echo $item_id; ?>" title="<?php esc_attr_e('Edit Menu Item','wpdancelaparis'); ?>" href="<?php
                        echo ( isset( $_GET['edit-menu-item'] ) && $item_id == $_GET['edit-menu-item'] ) ? admin_url( 'nav-menus.php' ) : add_query_arg( 'edit-menu-item', $item_id, remove_query_arg( $removed_args, admin_url( 'nav-menus.php#menu-item-settings-' . $item_id ) ) );
                    ?>"><?php _e( 'Edit Menu Item','wpdancelaparis' ); ?></a>
                </span>
            </dt>
        </dl>
        ...
        <div class="menu-item-settings" id="menu-item-settings-<?php echo $item_id; ?>">
            ...
            <p class="description description-thin">
                <label for="edit-menu-item-title-<?php echo $item_id; ?>">
                    <?php _e( 'Navigation Label','wpdancelaparis' ); ?><br />
                    <input type="text" id="edit-menu-item-title-<?php echo $item_id; ?>" class="widefat edit-menu-item-title" name="menu-item-title[<?php echo $item_id; ?>]" value="<?php echo esc_attr( $item->title ); ?>" />
                </label>
            </p>
            <p class="description description-thin">
                <label for="edit-menu-item-attr-title-<?php echo $item_id; ?>">
                    <?php _e( 'Title Attribute','wpdancelaparis' ); ?><br />
            ...
            <p class="field-link-target description">
                <label for="edit-menu-item-target-<?php echo $item_id; ?>">
                    ...
                    <?php _e( 'Open link in a new window/tab','wpdancelaparis' ); ?>
                </label>
            </p>
            <p class="field-css-classes description description-thin">
                <label for="edit-menu-item-classes-<?php echo $item_id; ?>">
                    <?php _e( 'CSS Classes (optional)','wpdancelaparis' ); ?><br />
                    <input type="text" id="edit-menu-item-classes-<?php echo $item_id; ?>" class="widefat code edit-menu-item-classes" name="menu-item-classes[<?php echo $item_id; ?>]" value="<?php echo esc_attr( implode(' ', $item->classes ) ); ?>" />
                </label>
            </p>
            <p class="field-xfn description description-thin">
                <label for="edit-menu-item-xfn-<?php echo $item_id; ?>">
                    <?php _e( 'Link Relationship (XFN)','wpdancelaparis' ); ?><br />
                    <input type="text" id="edit-menu-item-xfn-<?php echo $item_id; ?>" class="widefat code edit-menu-item-xfn" name="menu-item-xfn[<?php echo $item_id; ?>]" value="<?php echo esc_attr( $item->xfn ); ?>" />
                </label>
            </p>
            <p class="field-description description description-wide">
                <label for="edit-menu-item-description-<?php echo $item_id; ?>">
                    <?php _e( 'Description','wpdancelaparis' ); ?><br />
                    <textarea id="edit-menu-item-description-<?php echo $item_id; ?>" class="widefat edit-menu-item-description" rows="3" cols="20" name="menu-item-description[<?php echo $item_id; ?>]"><?php echo esc_html( $item->description ); // textarea_escaped ?></textarea>
                    <span class="description"><?php _e('The description will be displayed in the menu if the current theme supports it.','wpdancelaparis'); ?></span>
                </label>
            </p>        
            <?php
            /*
            ...
            <p class="field-wide-style description description-thin wd-custom-menu wd-add-on-lv0">
                <label for="edit-menu-item-wide-style-<?php echo $item_id; ?>">
                    ...
                    <?php _e( 'Mega Menu','wpdancelaparis' ); ?><br />
			...
			<p class="field-search-style description description-thin wd-custom-menu wd-add-on-lv0 mega-active">
                <label for="edit-menu-item-wide-search-<?php echo $item_id; ?>">
					<?php $_search = esc_attr( $item->search_style );?>
                    <?php _e( 'Search Menu','wpdancelaparis' ); ?><br />
					<select id="edit-menu-item-search-style-<?php echo $item_id; ?>" class="widefat code edit-menu-item-search-style" name="menu-item-search-style[<?php echo $item_id; ?>]">
					  <option value="0" <?php if($_search == 0) echo "selected";?> >No</option>
					  <option value="1" <?php if($_search == 1) echo "selected";?> >Yes</option>
					</select> 
                </label>
            </p>			
			
			<p class="field-wide-column description description-thin wd-custom-menu wd-add-on-lv0 mega-active depend-field-search-style">
                <label for="edit-menu-item-wide-column-<?php echo $item_id; ?>">
					<?php $wide_column = esc_attr( $item->wide_column );?>
                    <?php _e( 'Columns','wpdancelaparis' ); ?><br />
			...
			<p class="field-sub-column description description-thin wd-custom-menu wd-add-on-lv1 parrent-active depend-field-wide-column">
                <label for="edit-menu-item-sub-column-<?php echo $item_id; ?>">
                    ...
                    <?php _e( 'Sub Columns','wpdancelaparis' ); ?><br />
            ...
            <p class="field-wide-custom-color description description-thin wd-custom-menu wd-custom-color-menu wd-add-on-lv1 wd-add-on-lv2 parrent-active" >
                <label for="edit-menu-item-wide-custom-color-<?php echo $item_id; ?>">
                    <?php _e( 'Text Color','wpdancelaparis' ); ?><br />
			...
			<?php if( $numSideBar > 0):?>
					<p class="field-wide-widget description description-thin wd-custom-menu wd-add-on-lv0 wd-add-on-lv1 mega-active parrent-active depend-field-search-style">
						<label for="edit-menu-item-sidebars-<?php echo $item_id; ?>">
							<span class="description"><?php _e('Display a Widget Area','wpdancelaparis'); ?></span>
							<?php echo wd_mega_select_sidebar($item_id,$numSideBar); ?>
						</label>
					</p>
			<?php endif ?>	

            <p class="field-thumbnail description description-thin wd-custom-menu wd-add-on-lv1 wd-add-on-lv2 wd-add-on-lv0 parrent-active depend-field-search-style">
                <label>
					<?php 
						$menu_thumbnail = esc_attr( $item->thumbnail );
						$have_thumb = ( strlen($menu_thumbnail) > 0 ? true : false );
					?>
                    <?php _e( 'Set Image','wpdancelaparis' ); ?><br />
            ...
            <p class="field-wide-column description description-thin wd-custom-menu wd-add-on-lv0 mega-active" >
                <label for="edit-menu-item-wide-align-right-<?php echo $item_id; ?>">
					...
					?>
                    <?php _e( 'Align Right','wpdancelaparis' ); ?><br />
            ...
            <div class="menu-item-actions description-wide submitbox">
                <?php if( 'custom' != $item->type && $original_title !== false ) : ?>
                    <p class="link-to-original">
                        <?php printf( __('Original: %s','wpdancelaparis'), '<a href="' . esc_attr( $item->url ) . '">' . esc_html( $original_title ) . '</a>' ); ?>
                    </p>
                <?php endif; ?>
                ...
                ); ?>"><?php _e('Remove','wpdancelaparis'); ?></a> <span class="meta-sep"> | </span> <a class="item-cancel submitcancel" id="cancel-<?php echo $item_id; ?>" href="<?php echo esc_url( add_query_arg( array('edit-menu-item' => $item_id, 'cancel' => time()), remove_query_arg( $removed_args, admin_url( 'nav-menus.php' ) ) ) );
                    ?>#menu-item-settings-<?php echo $item_id; ?>"><?php _e('Cancel','wpdancelaparis'); ?></a>
            </div>
