		...
		<div class="wd_tini_account_wrapper <?php echo esc_attr($class) ?> <?php echo esc_attr($class_show_title) ?>">
			<div class="wd_tini_account_control">
				<a href="<?php echo esc_url($myaccount_page_url);?>" title="<?php esc_html_e('My Account','wpdancelaparis'); ?>">
					...
					<?php else:?>
						<span><?php esc_html_e('Sign Up / Login','wpdancelaparis');?></span>
					<?php endif;?>		
				</a>	
			</div>
			<div class="form_drop_down drop_down_container <?php echo esc_url($_user_logged) ? "hidden" : "";?>">
				...
				<?php else: ?>	
					<span class="my_account_wrapper"><a href="<?php echo esc_url($url = admin_url( 'profile.php', 'https' )); ?>" title="<?php esc_html_e('My Account','wpdancelaparis');?>"><?php esc_html_e('My Account','wpdancelaparis');?></a></span>
					<span class="logout_wrapper"><a href="<?php echo esc_url(wp_logout_url( get_permalink())); ?>" title="<?php esc_html_e('Logout','wpdancelaparis');?>"><?php esc_html_e('Logout','wpdancelaparis');?></a></span>
				<?php endif; ?>
			</div>
		</div>
		<?php 
